...
public class StudentCertificationAnswersUseCase {
    ...
    public CertificationStudentEntity execute(StudentCertificationAnswerDTO dto) throws Exception{
        ...
        dto.getQuestionsAnswers().stream().forEach(questionAnswer -> {
            ...
            var answersCertificationEntity = AnswersCertificationsEntity.builder().answerID(questionAnswer.getAlternativeID()).questionID(questionAnswer.getQuestionID())
        ...
        if(student.isEmpty()){
            var studentCreateded = StudentEntity.builder().email(dto.getEmail()).build();
            studentCreateded = studentRepository.save(studentCreateded);
            studentID = studentCreateded.getId();
        }else
        ...
        answersCertifications.stream().forEach(answerCertification ->{
            answerCertification.setAnswerID(certificationStudentEntity.getId());
